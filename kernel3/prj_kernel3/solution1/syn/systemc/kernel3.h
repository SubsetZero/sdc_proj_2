...
struct kernel3 : public sc_module {
    ...
    sc_in< sc_lv<32> > a_q0;
    sc_out< sc_lv<11> > bias_address0;
    sc_out< sc_logic > bias_ce0;
    sc_in< sc_lv<32> > bias_q0;
    sc_out< sc_lv<11> > index_address0;
    ...
    sc_signal< sc_lv<12> > i_fu_88_p2;
    sc_signal< sc_lv<12> > i_reg_108;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<1> > icmp_ln5_fu_82_p2;
    sc_signal< sc_lv<11> > a_addr_reg_123;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<32> > bias_load_reg_128;
    sc_signal< sc_lv<32> > a_load_reg_133;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<32> > grp_fu_78_p2;
    sc_signal< sc_lv<32> > tmp_reg_138;
    sc_signal< sc_logic > ap_CS_fsm_state8;
    sc_signal< sc_lv<12> > i_0_reg_67;
    sc_signal< sc_logic > ap_CS_fsm_state9;
    sc_signal< sc_lv<64> > zext_ln7_fu_94_p1;
    sc_signal< sc_lv<64> > sext_ln7_fu_100_p1;
    ...
    void thread_sext_ln7_fu_100_p1();
    void thread_zext_ln7_fu_94_p1();
